    ...
    <div class="div-for-card" >
      <div class="cards-list">
        <div class="card 1">
          ...
          <a class="addman-link" href="qr.php" 
              ><img src="./images/checklist(1).png" /></a></div>
        ...
        <div class="card 2">
          <div class="card_image">
            <a class="addman-link" href="checkmain.php" 
              ><img src="./images/timetable.png" /></a>
          </div>
          <div class="card_title title-white">
        ...
        <div class="card 3">
          <div class="card_image">
            <a class="addman-link" href="addmanually.php" 
              ><img id="addman" src="./images/resume.png"
            /></a>
          </div>
